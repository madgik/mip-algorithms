...
-- drop table if exists mytable;create table mytable as select * from (file header:t 'Normalizedtable.csv');
...
select rid, %{a} from (select %{columns}, rid, dataset from %{input_local_tbl})
